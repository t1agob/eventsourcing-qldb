...
adid=$(curl -s --location --request POST "https://w80y9csd6a.execute-api.eu-west-1.amazonaws.com/prod/publisher/$publisherId/ad" \
...
## UPDATE AD
curl --location --request PATCH "https://w80y9csd6a.execute-api.eu-west-1.amazonaws.com/prod/publisher/$publisherId/ad/$adid" \
--header 'X-Amz-Content-Sha256: beaead3198f7da1e70d03ab969765e0821b24fc913697e929e726aeaebf0eba3' \
...
curl --location --request GET "https://w80y9csd6a.execute-api.eu-west-1.amazonaws.com/prod/publisher/$publisherId/ad" \
...
## GET SPECIFIC AD
curl --location --request GET "https://w80y9csd6a.execute-api.eu-west-1.amazonaws.com/prod/publisher/$publisherId/ad/$adid" \
...
curl --location --request GET "https://w80y9csd6a.execute-api.eu-west-1.amazonaws.com/prod/publisher/$publisherId/ad/$adid?versions=true" \
